...
<CRANTaskView>
  ...
  <version date="2008-02-15">1.0</version>
...
\verb/<version>/ gives the version number (in a format recognized by \textsf{R},
with support for specification of an associated date (in ISO format).
