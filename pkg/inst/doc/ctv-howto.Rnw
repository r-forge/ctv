...
\verb/<bioc>/, \verb/<forge>/, and \verb/<code>/. \verb/<pkg>/ and
...
hyperlinks to the packages/views. Similarly, \verb/<bioc>/ and \verb/<forge>/can be used to
refer to projects on Bioconductor and \textsf{R}-Forge. These will be replaced by the appropriate
hyperlinks to the project on \texttt{http://www.Bioconductor.org/}
and \texttt{http://R-Forge.R-project.org/}, respectively.
