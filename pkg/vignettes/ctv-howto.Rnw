...
\verb/<bioc>/, \verb/<ohat>/, \verb/<rforge>/, \verb/<github>/, \verb/<gcode>/, and \verb/<code>/. \verb/<pkg>/ and
...
can be used to refer to projects on Bioconductor, Omegahat, \textsf{R}-Forge, GitHub, and Google Code.
...
\texttt{https://R-Forge.R-project.org/}, \texttt{https://www.GitHub.com/}, and \texttt{https://Code.Google.com/}, respectively.
